const Home = () => {
  return (
    <div>
      ...
      <p>If you're here from a <a href="/assets/Coty Janeway Resume.pdf" target="_blank" rel="noopener"><strong>resume</strong></a> or just curious, feel free to explore — and if you want to reach me, you can find my links in the navbar on the right.</p>
      <p></p>
